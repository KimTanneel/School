...
#include<iomanip>
using namespace std;
string createUpdateBrString(int ID1, string name1, string price1, string detail1)
{
	return "Update NhanVien set name1 = \"" + name1 + "\", price = \"" + price1 + "\", detail = \"" + detail1 + "\" where id = " + to_string(ID1);
}
...
string CreatString(int ID, string name, string price, string detail)
{
	...
	//insert into NHANVIEN values(6, 'ab', '2000-05-12', '1')
	// 
	return str1;
}
...
wstring s2ws(const std::string& s)
{
	...
	void DBHelper::init()
	{
		...
		switch (SQLDriverConnect(sqlConnHandle,
			...
			(SQLWCHAR*)L"DRIVER={SQL Server};SERVER=DESKTOP-85MQEKU;DATABASE=Bakery;Trusted=true;",
			SQL_NTS,
			retconstring,
			1024,
			NULL,
	...
	void DBHelper::execute()
	{
		...
		case 2:
		{
			...
			/*string str = "insert into CHUCVU values (10 , 'b'); insert into NHANVIEN values(10, 'ab', '2000-05-12', '1');";*/
			...
			/* L"insert into CHUCVU values (6,'b');insert into NHANVIEN values (6,'ab','2000-05-12','1');"*/
				//declare output variable and pointer
